...
> 通过企业微信远程控制电脑上的 iFlow CLI，随时随地用手机操控 AI 编程助手。
...
3. **企业微信管理员权限**（用于创建自建应用）
4. **cloudflared**（用于内网穿透，[安装指南](https://developers.cloudflare.com/cloudflare-one/connections/connect-apps/install-and-setup/installation/)）
...
```bash
git clone https://github.com/你的用户名/iflow-wechat-assistant.git
